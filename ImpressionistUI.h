...
// for brush dialog
	...
	Fl_Slider*			m_BrushThickSlider;
	Fl_Slider*			m_BrushAngleSlider;
	Fl_Slider*			m_BrushAlphaSlider;
	Fl_Button*          m_ClearCanvasButton;
	//Fl_Button*          m_StrokeButton;
	...
	//getalpha
	float				getAlpha();
	void				setAlpha(float a_value);
	int                 getLineMouseAngle(const Point start,const Point end);
...
private:
	...
	static Fl_Menu_Item		strokeChoiceMenu[3+1];
